...
public class StagingTabController
{
        ...
        Color inactiveTabColor)
    {
        ...
        this.atlasTabButton = atlasTabButton;
    ...
    public void RegisterTabButtons(
        UnityAction showWeaponsTab,
        UnityAction showMapsTab,
        UnityAction showEquipmentTab,
        UnityAction showAtlasTab)
    {
        tabButtons.Clear();
        ...
        AddTabButton(atlasTabButton, showAtlasTab);
    }
    ...
    private void RefreshPanelVisibility()
    {
        ...
        if (atlasPanel != null)
        {
            atlasPanel.SetActive(currentTab == Tab.Atlas);
        }
    }
